...
<div class="hero">
  <div class="container overflow-hidden py-5">
    <div class="row">
      <div class="col-lg-8 d-flex flex-column align-items-lg-start justify-content-lg-center text-center text-lg-start gap-3">
        ...
        <p class="align-self-lg-start d-flex align-self-center">
          <?= Utils::buttonCTA($configData['orderID'], $content['web_target']) ?>
        </p>
        
      </div>
    </div>
    <img src="https://www.stanislav-drako.cz/public/img/cleaning.webp" alt="hero" class="img-fluid">
    
    <div class="bubbles bubble d-none d-lg-block"></div>  
    <img src="https://www.stanislav-drako.cz/public/img/dots.webp" alt="" class="dots d-none d-lg-block">
    ...
    <div class="container overflow-hidden">
      ...
      <div class="col-md-4 col-lg-6 order-2">
        ...
        <div class="d-flex justify-content-center h-100">
            ...
            <img src="https://www.stanislav-drako.cz/public/img/demo5-about.webp" alt="obrázek o nás" class="img-fluid">
  ...
  <section id="pricing">
    <div class="container pb-5 overflow-hidden">
      ...
      <?php foreach($services as $s) : ?>
          <div class="col-lg-8">
            <div class="d-flex flex-column justify-content-between gap-2 border-bottom">
  ...
  <div class="container-fluid overflow-hidden">
    <div class="row justify-content-center g-5">
      <div class="col-12 col-lg-8">
        <div class="d-flex bg-white rounded-2 flex-column justify-content-center align-items-center gap-3 py-5">
          <div class="col-10 p-lg-4 p-0">
            <h2 class="text-center pb-3"><?= $content['cta_title'] ?></h2>
